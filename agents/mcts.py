...
class TreeNode(object):
    ...
    def select(self, c_puct):
        ...
        """
        # print([(a, v.get_value(c_puct)) for a, v in self._children.items()])
...
class MCTS(object):
    ...
    def _playout(self, env, isTraining, hiddenState):
        ...
        prob, leaf_value, _ = self._policy(state, mask, isTraining, hiddenState)
        ...
        # 否则: 如果胜利者是当前的，那么leaf_value = 1， 否则leaf_value = -1
            ...
            leaf_value = env.getDoneReward()
        # 向上更新祖先节点。
        # Update value and visit count of nodes in this traversal.
        node.update_recursive(-leaf_value)


    def get_move_probs(self, env, isTraining, hiddenState, temp=1e-3):
        ...
        for _ in range(self._n_playout):
            ...
            self._playout(env_copy, isTraining, hiddenState)
        ...
        # visits = [node._n_visits for act, node in self._root._children.items()]
        # act_probs = softmax(1.0/temp * np.log(np.array(visits) + 1e-10))
        # return act_probs
